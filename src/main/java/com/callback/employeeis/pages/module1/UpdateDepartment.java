...
public class UpdateDepartment extends javax.swing.JFrame {
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        searchDepartmentCode.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        ...
        searchBtn.setForeground(new java.awt.Color(255, 204, 0));
        ...
        updateDeparmentName.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
  ...
  private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
    ...
    try {
      if (department.checkDepartmentName(departName)) { 
        department.updateDepartment(departName, departmentCodeInput);
